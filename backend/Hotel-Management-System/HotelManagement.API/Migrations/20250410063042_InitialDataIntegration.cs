...
{
    /// <inheritdoc />
    public partial class InitialDataIntegration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 4, 9, 6, 30, 42, 264, DateTimeKind.Utc).AddTicks(9089), "admin1@example.com", "Admin User 1", true, new DateTime(2025, 4, 10, 6, 30, 42, 264, DateTimeKind.Utc).AddTicks(9235), "hashed_password_1", "1234567801", null, "SuperAdmin", "admin1" },
